    ...
    public static void LoadArenasFromConfig(){
        ...
        for (File file : arenasFiles){
            ...
            arenas.add(new Arena(configuration.getString("id"), configuration.getString("name"), configuration.getInt("maxGameLength"),
                    ...
                    configuration.getLocation("lobbyLocation"), configuration.getLocation("hubLocation"), configuration.getLocation("spectatorsSpawnLocation"),
                    configuration.getInt("minY"), snowLayers, configuration.getInt("blocksForBooster"), spectatorsArea));
        }
    }
}
